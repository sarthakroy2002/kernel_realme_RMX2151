...
static struct imgsensor_info_struct imgsensor_info = {
  ...
  /*     following for MIPIDataLowPwr2HighSpeedSettleDelayCount by different scenario    */
    ...
    .custom1 = {
            .pclk = 16500000,            //record different mode's pclk
            .linelength = 448,            //record different mode's linelength
            .framelength = 1532,            //record different mode's framelength
            .startx = 0,                    //record different mode's startx of grabwindow
            .starty = 0,                    //record different mode's starty of grabwindow
            .grabwindow_width = 1600,        //record different mode's width of grabwindow
            .grabwindow_height = 1200,        //record different mode's height of grabwindow
            ...
            *sensor_id = (return_sensor_id() + 1);
            ...
            if ((*sensor_id == imgsensor_info.sensor_id)
                ...
                if (deviceInfo_register_value == 0x00) {
                    register_imgsensor_deviceinfo("Cam_r3", DEVICE_VERSION_OV02B1B, imgsensor_info.module_id);
...
{
	pr_info("[ov02b1b] preview mode start\n");
...
static kal_uint32 capture(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_info("[ov02b1b] capture mode start\n");
...
static kal_uint32 normal_video(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_info("[ov02b1b] normal_video mode start\n");
...
static kal_uint32 hs_video(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_info("[ov02b1b] hs_video mode start\n");
...
static kal_uint32 slim_video(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_info("[ov02b1b] slim_video mode start\n");
