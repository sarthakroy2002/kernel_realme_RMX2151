            ...
            *sensor_id = return_sensor_id();
            ...
            if ((*sensor_id == imgsensor_info.sensor_id)
                ...
                if (deviceInfo_register_value == 0x00) {
                    if (check_eeprom_awb_golden(*sensor_id, 0xA4)) {
                        sprintf(sensor_name_golden_result, "%s_1", DEVICE_VERSION_OV02B10);
                    } else {
                        sprintf(sensor_name_golden_result, "%s_0", DEVICE_VERSION_OV02B10);
                    }
